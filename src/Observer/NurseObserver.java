 ...
 * @author USER
 */
public class NurseObserver implements Observer {
    ...
    public void update(Observable obj, Object arg) {
        System.out.println("Nurse :" + newLine + "Format:" + Format + newLine + "Severity Degree:" + Severity_Degree);
        msg.display(Format, (Notification) arg);
        System.out.println();
    }

    public NurseObserver(String Format, int Severity_Degree) {
